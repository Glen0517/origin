...
#define MAX_EVENT_QUEUE_SIZE     100     // 事件队列最大长度（从50增加到100）

/******************************************************************************************
 * 事件优先级定义
 ******************************************************************************************/
#define EVENT_PRIORITY_HIGHEST   0       // 最高优先级
#define EVENT_PRIORITY_HIGH       3       // 高优先级
#define EVENT_PRIORITY_NORMAL     5       // 普通优先级
#define EVENT_PRIORITY_LOW        7       // 低优先级
#define EVENT_PRIORITY_LOWEST     9       // 最低优先级
