...
/******************************************************************************************
 * 【游戏音响功能总开关】- 控制所有游戏音响相关功能的编译
 * 取值：1-开启游戏音响功能  0-关闭游戏音响功能
 ******************************************************************************************/
#ifndef CONFIG_ENABLE_GAME_SPEAKER
#define CONFIG_ENABLE_GAME_SPEAKER    1   // 默认开启游戏音响功能
#endif
...
#elif defined(CONFIG_ENABLE_GAME_SPEAKER) && (CURRENT_PRODUCT_TYPE == PRODUCT_GAME_HIGH_END) || (CURRENT_PRODUCT_TYPE == PRODUCT_GAME_MID_END)
#define CONFIG_ENABLE_HDMI_ARC       1   // 开启HDMI ARC
#define CONFIG_ENABLE_SPDIF          1   // 开启光纤/同轴
#elif defined(CONFIG_ENABLE_GAME_SPEAKER) && (CURRENT_PRODUCT_TYPE == PRODUCT_GAME_LOW_END)
...
#elif defined(CONFIG_ENABLE_GAME_SPEAKER) && (CURRENT_PRODUCT_TYPE == PRODUCT_GAME_HIGH_END)
#define CONFIG_ENABLE_DOLBY_DTS      1   // 开启杜比DTS解码
#define CONFIG_ENABLE_VIRTUAL_5_1    1   // 开启虚拟5.1声场
#define CONFIG_ENABLE_WIFI_MEDIA     1   // 开启WIFI投屏
#define CONFIG_ENABLE_IR_LEARN       1   // 开启红外学习
...
#elif defined(CONFIG_ENABLE_GAME_SPEAKER) && (CURRENT_PRODUCT_TYPE == PRODUCT_GAME_MID_END)
#define CONFIG_ENABLE_DOLBY_DTS      0   // 屏蔽杜比DTS
#define CONFIG_ENABLE_VIRTUAL_5_1    0   // 屏蔽虚拟5.1
#define CONFIG_ENABLE_WIFI_MEDIA     0   // 屏蔽WIFI投屏
#define CONFIG_ENABLE_IR_LEARN       0   // 屏蔽红外学习
...
#elif defined(CONFIG_ENABLE_GAME_SPEAKER) && (CURRENT_PRODUCT_TYPE == PRODUCT_GAME_HIGH_END)
#define CONFIG_ENABLE_BT_MESH        1   // 开启蓝牙MESH
#elif defined(CONFIG_ENABLE_GAME_SPEAKER) && (CURRENT_PRODUCT_TYPE == PRODUCT_GAME_MID_END || CURRENT_PRODUCT_TYPE == PRODUCT_GAME_LOW_END)
